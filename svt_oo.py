...
class PyramidVisionTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=None,
                 ...
                 depths=None, sr_ratios=None, block_cls=GroupBlock):
        super().__init__()
...
# def svt_tiny(num_classes: int = 1000):
...
def svt_small(num_classes: int = 1000):
    model = PyramidVisionTransformer(
        patch_size=4,
        wss=[7, 7, 7, 7],
        embed_dims=[64, 128, 256, 512],
...
def svt_base(num_classes: int = 1000):
    model = PyramidVisionTransformer(
        patch_size=4,
        wss=[7, 7, 7, 7],
...
def svt_large(num_classes: int = 1000):
    model = PyramidVisionTransformer(
        patch_size=4,
        wss=[7, 7, 7, 7],
